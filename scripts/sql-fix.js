...
const SQL = `
-- Fix Return types for match_documents_hybrid
...
-- Fix Return types for match_documents_keyword
...
async function run() {
  ...
  if (error) {
    // If execute_sql_hack doesn't exist, I can't run raw SQL.
    // I would need to ask the user to run it.
    console.error('Cant run raw SQL via RPC unless execute_sql_hack is enabled. Error:', error);
  } else {
